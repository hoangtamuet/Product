...
myApp.controller('customersCtrl', function ($scope, $http) {
    ...
    var getData = function () {
        $http({
            method: "GET",
            url: "http://localhost:1000/api/customer"
    ...
    $scope.postData = function (id, name) {
        ...
        $scope.ND = parameter;
        $http.post("http://localhost:1000/api/customer/post", parameter).then(function (response) {
    ...
    $scope.editData = function (id, name) {
        var parameter = JSON.stringify({ id: id, name: name});
        $scope.ND = parameter;
        $http.put("http://localhost:1000/api/customer/put", parameter).then(function (response) {
    ...
    $scope.deleteData = function (id) {
        var url = "http://localhost:1000/api/customer/delete/" + id;
